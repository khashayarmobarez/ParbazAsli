...
const ClubHarnesses = (props) => {
    ...
    const { data: userEquipmentsHistoryData, refetch: refetchHistory } = useUserEquipmentsHistory(3, true)
    ...
    return (
        <div className=' flex flex-col gap-y-12 items-center'>
            ...
            <Link to='/club/addHarnessForClub' className='z-20 fixed bottom-[4rem] w-[90%]  rounded-xl md:w-96 md:relative md:bottom-0 md:top-4 h-[56px] '>
