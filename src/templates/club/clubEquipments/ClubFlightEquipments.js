...
const ClubFlightEquipments = () => {
    ...
    const { data: userEquipmentsData, isLoading, error, refetch: refetchUserEquipmentsData } = useUserEquipments(2, true)
    const { data: userEquipmentsHistoryData, refetch: refetchHistory } = useUserEquipmentsHistory(2, true)
    ...
    return (
        <div className=' flex flex-col gap-y-6 items-center '>
            ...
            <Link to='/club/addFlightEquipmentForClub' className='z-20 fixed bottom-[4rem] w-[90%] rounded-xl md:w-96 md:relative md:bottom-0 md:top-4 h-[56px] '>
...
export default ClubFlightEquipments;