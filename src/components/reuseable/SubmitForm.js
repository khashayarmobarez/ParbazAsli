...
const SubmitForm = ({ handleSubmit, showPopup, setShowPopup, handlePost, text }) => {
    ...
    return (
        <div>
            <div  className={` ${boxStyles.containerChangeOwnership} ${showPopup ? 'fixed' : 'hidden'}  w-[80%] md:w-[304px] h-[280px] flex flex-col justify-around items-center top-52 right-[10%]`}>
