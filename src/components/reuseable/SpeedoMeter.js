  ...
  return (
    ...
    <div className={`${boxStyles.containerDarkmode} rounded-3xl z-0 w-[98%] md:w-full flex justify-between items-center px-2 py-3 mr-1 mt-1`}>
        ...
        <div className='flex flex-col justify-center items-center space-y-4'>
            ...
            <p className=' font-normal text-xs mr-2 text-textDisabled'>{parachuteData.remainingTimeToRepackInDays} روز تا نیاز به بسته بندی مجدد</p> 
        </div>
        ...
        <div className='w-[143px] h-[143px] flex flex-col justify-center items-center mb-[-0.5rem]'>
                    ...
                    {(value) => (
                        ...
                        styles={{
                            ...
                            stroke: 'var(--bg-button-secondary-default)'
                            },
                            path: {
                            strokeLinecap: 'round',
                            transform: 'rotate(-126deg)',
        ...
        <svg style={{ height: 0, width: 0, position: 'absolute' }}>
          <defs>
            <linearGradient id="gradient" x1="0%" y1="100%" x2="70%" y2="0%">
              <stop offset="10%" stop-color="rgba(35, 188, 124, 1)"></stop>
              <stop offset="50%" stop-color="rgba(255, 153, 0, 1)"></stop>
              <stop offset="90%" stop-color="rgba(220, 53, 69, 1)"></stop>
            </linearGradient>
          </defs>
        </svg>
