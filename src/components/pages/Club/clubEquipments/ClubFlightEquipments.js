...
const FlightEquipment = () => {
    ...
    const { data: userEquipmentsHistoryData, HistoryLoading, historyError, refetch: refetchHistory } = useUserEquipmentsHistory(2, true)
    ...
    return (
        <div className=' flex flex-col gap-y-6 items-center '>
            ...
            <Link to='/club/addFlightEquipmentForClub' className='z-20 fixed bottom-[3.2rem] w-[90%] bg-[#131423] rounded-xl md:w-96 md:relative md:bottom-0 md:top-4 h-[56px] '>
