...
// queiries
import { useAClubClass } from '../../../../../Utilities/Services/clubQueries';
...
const ClubCourseClassBox = (props) => {
    ...
    const {  data: classDetails, isLoading: classDetailsLoading, error: classDetailsError } = useAClubClass(classData.id);
...

                {
                    ...
                    <>
                        ...
                        {isExpanded && classDetails &&
                            ...
                            { extraData &&
                                <div id='no grid list' className='w-[90%] flex flex-col items-center gap-y-5 mt-6'>
...
export default ClubCourseClassBox;