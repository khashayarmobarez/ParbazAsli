...
const InputWithButton = ({icon, buttonText, placeH, Type}) => {
    return (
            <div className={` flex relative w-[100%] h-12 px-2`}>
                ...
                <input type={Type} id={'test'} placeholder={placeH} className={` w-[100%] text-sm font-medium pr-8 rounded-r-2xl rounded-l-none`} style={{background:'var(--dark-input-bg)', boxShadow:'var(--dark-input-boxShadow)'}} />
