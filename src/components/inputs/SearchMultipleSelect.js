  ...
  return (
    <div className='flex flex-col w-full' ref={dropdownRef}>
      <div className='flex relative w-[100%] h-12 rounded-xl'>
        <span>
          <img src={Icon || Cube} alt='icon' className='absolute mt-4 mr-2 w-5' />
        </span>
        <input
          ref={inputRef}
          type="text"
...
//       {isOpen && (
//         <div className=' w-[90%] absolute top-32 z-30 h-[70vh] bg-light-yellow flex flex-col items-center justify-between'>
...
//           <ul className=" w-full mt-12 bg-[var(--dark-blue-bg)] rounded-2xl shadow-lg max-h-[80%] overflow-auto">
//             {filteredOptions.map((option) => (
//               <div className='flex flex-col w-full items-center justify-center '>
//                 <li
//                   key={option.id}
