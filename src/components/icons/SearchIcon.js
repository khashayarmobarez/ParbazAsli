...
const SearchIcon = ({anotherColor}) => {
    ...
    return (
        <svg width="v" height="v" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            stroke={anotherColor || color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    );
};
